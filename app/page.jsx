...
const GlowingStar = ({ scrollYProgress, index }) => {
  ...
  return (
    <motion.div
      style={{ opacity, scale }}
      className="absolute left-[22px] md:left-[calc(50%-6px)] -translate-x-1/2 top-6 md:top-1/2 md:-translate-y-1/2 w-6 h-6 z-20 flex items-center justify-center drop-shadow-[0_0_10px_rgba(194,208,153,0.8)]"
    >
